...
if __name__ == "__main__":
    with app.app_context():
        ...
        leaderboard_files = glob("./backend/leaderboards/in_time/*")        # This section formats everything nicely for the charts!
        labels = []
        min_monies = []
        max_monies = []
        q1_monies = []
        ...
        for file in leaderboard_files:
            ...
            date_time_str = datetime.strptime(date_time_str, '%Y-%m-%d-%H:%M').strftime("%H:%M:%S %m-%d-%Y") # The final string in the right format
            ...
            _1, q1_money, median_money, q3_money, _2 = get_five_number_summary(df2) # get some key numbers for the charts
        ...
        df = df[["Ranking", "Account Name", "Money In Account", "Z-Score", "Investopedia Link"]] # This rearranges the columns to make things be in the right order
