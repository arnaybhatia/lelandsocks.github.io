...
async def main(username, password):
    async with async_playwright() as p:
        ...
        try:
            ...
            await page.set_user_agent('Mozilla/5.0 (X11; Linux x86_64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/78.0.3904.108 Safari/537.36')
            ...
            login_button = await page.wait_for_selector('//span[contains(text(),"LOG IN")]', timeout=3000)
            await login_button.click()
            await wait_for(6000)

            username_field = await page.wait_for_selector('//input[@id="username"]', timeout=3000)
            password_field = await page.wait_for_selector('//input[@id="password"]', timeout=3000)
            sign_in_button = await page.wait_for_selector('//input[@id="login"]', timeout=3000)
            ...
            password_field_2 = await page.wait_for_selector('//input[@id="password"]', timeout=3000)
            ...
            sign_in_button_2 = await page.wait_for_selector('//input[@id="login"]', timeout=3000)
